...
void test_ann() {
	...
	*/
	...
	m_batch* mb_input = load_data_into_batches(data, 16, 1);
	m_batch* mb_output = load_data_into_batches(data, 16, 1);
	...
	fprintf(stdout, "\n--------------------\nEND TESTING OF NEURAL NETWORK INITIALIZATION AND PASS THROUGH\n--------------------\n");
}
